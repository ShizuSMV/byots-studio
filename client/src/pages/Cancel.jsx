    ...
    <Layout>
      <div className="result-page">
        <div className="result-page__card">
          <svg className="result-page__icon" width="44" height="44" viewBox="0 0 44 44" fill="none">
            <circle cx="22" cy="22" r="20" stroke="currentColor" strokeWidth="1.5"/>
            <path d="M15 29l14-14M29 29L15 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          </svg>
