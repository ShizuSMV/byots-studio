    ...
    <Layout>
      <div className="result-page">
        <div className="result-page__card result-page__card--success">
          <svg className="result-page__icon result-page__icon--success" width="44" height="44" viewBox="0 0 44 44" fill="none">
            <circle cx="22" cy="22" r="20" stroke="currentColor" strokeWidth="1.5"/>
            <path d="M13 22l6.5 6.5L31 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
